    ...
    <div className="flex items-center justify-center min-h-screen bg-[var(--bg-color)] p-4">
      <Card className="w-full max-w-md shadow-2xl border-primary/10">
        ...
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" onClick={handleGoogleSignIn} className="w-full h-12 font-bold" disabled={isLoading}>
            {isLoading ? (
              <Loader2 className="mr-2 h-5 w-5 animate-spin" />
            ) : (
          ...
          <p className="text-center text-sm pt-2">
            ...
            <button
              ...
              disabled={isLoading}
              className="text-[var(--heading-color)] font-black hover:underline disabled:opacity-50"
            >
